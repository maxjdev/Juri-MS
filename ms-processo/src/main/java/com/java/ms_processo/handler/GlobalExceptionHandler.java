package com.java.ms_processo.handler;

import com.java.ms_processo.exceptions.ClienteNaoEncontradoException;
import com.java.ms_processo.handler.response.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleProcessoNaoEncontrado(ProcessoNaoEncontradoException ex, HttpServletRequest request) {
        // Log completa da exceção (inclui stacktrace)
        log.warn("Processo não encontrado: {}", ex.getMessage(), ex);
